...
module.exports = { 
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-LceiK9e500YIwVUg',
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2347042391196",
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "Akatsuki",
    ...
    BOT_NAME: process.env.BOT_NAME || "Akatsuki💀",
